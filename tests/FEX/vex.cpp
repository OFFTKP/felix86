...
VEX_TEST(fma_fmsub_ss)
VEX_TEST(fma_fmsub_sd)
VEX_TEST(fma_fmsub_ps)
VEX_TEST(fma_fmsub_pd)
VEX_TEST(fma_fnmadd_ss)
VEX_TEST(fma_fnmadd_sd)
VEX_TEST(fma_fnmadd_ps)
VEX_TEST(fma_fnmadd_pd)
VEX_TEST(fma_fnmsub_ss)
VEX_TEST(fma_fnmsub_sd)
VEX_TEST(fma_fnmsub_ps)
VEX_TEST(fma_fnmsub_pd)
VEX_TEST(fma_fmaddsub_ps)
VEX_TEST(fma_fmaddsub_pd)
VEX_TEST(fma_fmsubadd_ps)
VEX_TEST(fma_fmsubadd_pd)