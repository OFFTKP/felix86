...
BUG_TEST(shl_preserve)
BUG_TEST(shr_preserve)
BUG_TEST(sar_preserve)
BUG_TEST(rol_preserve)
BUG_TEST(ror_preserve)
BUG_TEST(rcl_preserve)
BUG_TEST(rcr_preserve)
BUG_TEST(shld_preserve)
BUG_TEST(shrd_preserve)
BUG_TEST(fcomp_order)
// BUG_TEST(crc_simple)
