...
private:
    ...
    static void EmitVSubByte(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
    static void EmitVAddByte(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
    static void EmitVAddWord(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
    static void EmitVAddDWord(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
    static void EmitVAddQWord(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
    static void EmitVEqualByte(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
    static void EmitVEqualWord(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
    static void EmitVEqualDWord(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
    static void EmitVEqualQWord(Backend&, biscuit::Vec, biscuit::Vec, biscuit::Vec);
};