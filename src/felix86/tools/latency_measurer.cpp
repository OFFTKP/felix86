...
const std::vector<Test>& tests() {
    ...
    static const std::vector<Test> list = {
        ...
        {"shl r, 1", ALL, [](Ctx& c) { c.x.shl(c.dst(), 1); }},
        {"shr r, 1", ALL, [](Ctx& c) { c.x.shr(c.dst(), 1); }},
        {"sar r, 1", ALL, [](Ctx& c) { c.x.sar(c.dst(), 1); }},
        {"rol r, 1", ALL, [](Ctx& c) { c.x.rol(c.dst(), 1); }},
        {"ror r, 1", ALL, [](Ctx& c) { c.x.ror(c.dst(), 1); }},
        {"rcl r, 1", ALL, [](Ctx& c) { c.x.rcl(c.dst(), 1); }},
        {"rcr r, 1", ALL, [](Ctx& c) { c.x.rcr(c.dst(), 1); }},
        ...
        {"cwd", W16, [](Ctx& c) { c.x.cwd(); }, true},
        {"cdq", W32, [](Ctx& c) { c.x.cdq(); }, true},
        {"cqo", W64, [](Ctx& c) { c.x.cqo(); }, true},
        {"lahf", W8HI, [](Ctx& c) { c.x.lahf(); }, true},
        {"sahf", W8HI, [](Ctx& c) { c.x.sahf(); }, true},
        {"xchg r, r", RR, [](Ctx& c) { c.x.xchg(c.dst(), c.src()); }},
        {"xadd r, r", RR, [](Ctx& c) { c.x.xadd(c.dst(), c.src()); }},
        {"cmpxchg r, r", RR, [](Ctx& c) { c.x.cmpxchg(c.dst(), c.src()); }},
        ...
        {"cmovbe r, r", W64 | W32 | W16, [](Ctx& c) { c.x.cmovbe(c.dst(), c.src()); }},
        {"cmovle r, r", W64 | W32 | W16, [](Ctx& c) { c.x.cmovle(c.dst(), c.src()); }},
        {"cmovs r, r", W64 | W32 | W16, [](Ctx& c) { c.x.cmovs(c.dst(), c.src()); }},
        {"cmovo r, r", W64 | W32 | W16, [](Ctx& c) { c.x.cmovo(c.dst(), c.src()); }},
        {"cmovp r, r", W64 | W32 | W16, [](Ctx& c) { c.x.cmovp(c.dst(), c.src()); }},
        {"setb r8", W8 | W8HI, [](Ctx& c) { c.x.setb(c.dst()); }},
        {"setl r8", W8 | W8HI, [](Ctx& c) { c.x.setl(c.dst()); }},
        {"setbe r8", W8 | W8HI, [](Ctx& c) { c.x.setbe(c.dst()); }},
        {"setle r8", W8 | W8HI, [](Ctx& c) { c.x.setle(c.dst()); }},
        {"sets r8", W8 | W8HI, [](Ctx& c) { c.x.sets(c.dst()); }},
        {"seto r8", W8 | W8HI, [](Ctx& c) { c.x.seto(c.dst()); }},
        {"setp r8", W8 | W8HI, [](Ctx& c) { c.x.setp(c.dst()); }},
        ...
        {"crc32 r, r16", W32, [](Ctx& c) { c.x.crc32(c.dst32e(), c.dst(16)); }},
        {"adcx r, r", W64 | W32, [](Ctx& c) { c.x.adcx(c.dst32e(), c.src()); }},
        {"adox r, r", W64 | W32, [](Ctx& c) { c.x.adox(c.dst32e(), c.src()); }},
        {"mulx r, r, r", W64 | W32, [](Ctx& c) { c.x.mulx(c.dst32e(), c.dst32e(), c.src()); }},
...
#define Y2I(name, bits)                                                                                                                              \
    {                                                                                                                                                \
        ...
        {"cvtss2si r, x; cvtsi2ss x, r", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.cvtss2si(r, c.xdst()); c.x.cvtsi2ss(c.xdst(), r); }},
        {"pmovmskb r32, x; movd x, r32", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.pmovmskb(r, c.xdst()); c.x.movd(c.xdst(), r); }},
        {"movmskps r32, x; movd x, r32", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.movmskps(r, c.xdst()); c.x.movd(c.xdst(), r); }},
        {"movmskpd r32, x; movd x, r32", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.movmskpd(r, c.xdst()); c.x.movd(c.xdst(), r); }},
        {"movd x, r32", XMM, [](Ctx& c) { c.x.movd(c.xdst(), c.src32()); }},
        {"movq x, r64", XMM, [](Ctx& c) { c.x.movq(c.xdst(), c.src64()); }},
        {"movq x, x", XMM, [](Ctx& c) { c.x.movq(c.xdst(), c.xsrc()); }},
        ...
        {"pextrb r32, x, imm; pinsrb x, r32, imm", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.pextrb(r, c.xdst(), c.imm(4)); c.x.pinsrb(c.xdst(), r, c.imm(4)); }},
        {"extractps r32, x, imm; pinsrd x, r32, imm", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.extractps(r, c.xdst(), c.imm(2)); c.x.pinsrd(c.xdst(), r, c.imm(2)); }},
        // {"pcmpistri x, x, imm", XMM, [](Ctx& c) { c.x.pcmpistri(c.xdst(), c.xsrc(), c.imm(7)); }, true},
        // {"pcmpistrm x, x, imm", XMM, [](Ctx& c) { c.x.pcmpistrm(c.xdst(), c.xsrc(), c.imm(7)); }, true},
        ...
        {"vmovq x, x", XMM, [](Ctx& c) { c.x.vmovq(c.xdst(), c.xsrc()); }},
        ...
        {"vpmovmskb r32, v; vmovd x, r32", VEC, [](Ctx& c) { auto& r = c.src32(); c.x.vpmovmskb(r, c.xdst()); c.x.vmovd(c.xdst128(), r); }},
        {"vmovmskps r32, v; vmovd x, r32", VEC, [](Ctx& c) { auto& r = c.src32(); c.x.vmovmskps(r, c.xdst()); c.x.vmovd(c.xdst128(), r); }},
        {"vmovmskpd r32, v; vmovd x, r32", VEC, [](Ctx& c) { auto& r = c.src32(); c.x.vmovmskpd(r, c.xdst()); c.x.vmovd(c.xdst128(), r); }},
        {"vzeroupper", YMM, [](Ctx& c) { c.x.vzeroupper(); }, true},
        {"vzeroall", YMM, [](Ctx& c) { c.x.vzeroall(); }, true},
        ...
        {"vcvtss2si r, x; vcvtsi2ss x, x, r", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.vcvtss2si(r, c.xdst()); c.x.vcvtsi2ss(c.xdst(), c.xdst(), r); }},
        {"vcvtsd2si r, x; vcvtsi2sd x, x, r", XMM, [](Ctx& c) { auto& r = c.src64(); c.x.vcvtsd2si(r, c.xdst()); c.x.vcvtsi2sd(c.xdst(), c.xdst(), r); }},
        ...
        {"vpextrb r32, x, imm; vpinsrb x, x, r32, imm", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.vpextrb(r, c.xdst(), c.imm(4)); c.x.vpinsrb(c.xdst(), c.xdst(), r, c.imm(4)); }},
        {"vpextrw r32, x, imm; vpinsrw x, x, r32, imm", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.vpextrw(r, c.xdst(), c.imm(3)); c.x.vpinsrw(c.xdst(), c.xdst(), r, c.imm(3)); }},
        {"vextractps r32, x, imm; vpinsrd x, x, r32, imm", XMM, [](Ctx& c) { auto& r = c.src32(); c.x.vextractps(r, c.xdst(), c.imm(2)); c.x.vpinsrd(c.xdst(), c.xdst(), r, c.imm(2)); }},
        // {"vpcmpistri x, x, imm", XMM, [](Ctx& c) { c.x.vpcmpistri(c.xdst(), c.xsrc(), c.imm(7)); }, true},
        // {"vpcmpistrm x, x, imm", XMM, [](Ctx& c) { c.x.vpcmpistrm(c.xdst(), c.xsrc(), c.imm(7)); }, true},
        // {"vpcmpestri x, x, imm", XMM, [](Ctx& c) { c.x.vpcmpestri(c.xdst(), c.xsrc(), c.imm(7)); }, true},
        // {"vpcmpestrm x, x, imm", XMM, [](Ctx& c) { c.x.vpcmpestrm(c.xdst(), c.xsrc(), c.imm(7)); }, true},
        V3(vaesenc, XMM), V3(vaesenclast, XMM), V3(vaesdec, XMM), V3(vaesdeclast, XMM), V2(vaesimc, XMM),  V3I(vpclmulqdq, XMM, 8),
