...
#define _Regs_(mnemonic, first_reg, second_reg) {(InstructionWrapper(ZYDIS_MNEMONIC_##mnemonic, ZYDIS_REGISTER_##first_reg, ZYDIS_REGISTER_##second_reg))}
...
#define RESET_STATE() prepattern = nullptr; \
                    postpattern = nullptr; \
                    postpattern_index = 0; \
                    prepattern_index = 0; \
                    state = Scanning
