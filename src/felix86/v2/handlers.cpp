...
FAST_HANDLE(CALL_rsb) {
    ...
    // If there's indirect linking, the jump will take 11 * 4 + 3 * 8 for the literals
    int offset = (g_dont_link_indirect || operands[0].type == ZYDIS_OPERAND_TYPE_IMMEDIATE) ? 20 : 20 + (11 * 4 + 3 * 8);
