...
ir_instruction_t* ir_emit_extract_integer_from_vector(ir_instruction_list_t* instructions,
                                                      ir_instruction_t* src, u8 idx, x86_size_e sz)
{
    ir_instruction_t* index = ir_emit_immediate(instructions, idx);
    ir_instruction_t* size = ir_emit_immediate(instructions, sz);
...
ir_instruction_t* ir_emit_vector_packed_shift_right(ir_instruction_list_t* instructions,
                                                    ir_instruction_t* source, ir_instruction_t* imm)
{
...
void ir_emit_group1_imm(ir_instruction_list_t* instructions, x86_instruction_t* inst)
{
    ...
    switch (opcode)
    {
        ...
        case X86_GROUP1_ADC:
        {
            ...
            o = ir_emit_get_overflow_add(instructions, rm, imm_carry, result,
                                         inst->operand_rm.size);
        ...
        case X86_GROUP1_SBB:
        {
            ...
            o = ir_emit_get_overflow_sub(instructions, rm, imm_carry, result,
                                         inst->operand_rm.size);
                    ...
                    ir_instruction_t* shift_amount)
{
    ...
    switch (opcode)
    {
        ...
        case X86_GROUP2_SHL:
        {
            ir_instruction_t* msb_mask =
                ir_emit_get_shift_mask_left(instructions, shift_value, size_e);
        ...
        case X86_GROUP2_SAR:
        {
            ...
            ir_instruction_t* shift_right =
                ir_emit_add(instructions, shift_left_count, shift_value);
    ...
    switch (opcode & 0xF)
    {
        ...
        case 14:
            return ir_emit_or(
                ...
                ir_emit_not_equal(instructions, ir_emit_get_flag(instructions, X86_REF_SF),
                                  ir_emit_get_flag(instructions, X86_REF_OF)));
        case 15:
            return ir_emit_and(
                instructions,
