...
#define PR_GET_AUXV 0x41555856
    ...
    case felix86_riscv64_splice: {
        result = SYSCALL(splice, arg1, arg2, arg3, arg4, arg5, arg6);
        break;
    }
    ...
    case felix86_riscv64_execve: {
        ...
        envp.push_back(extensions_env.c_str());
...
void felix86_syscall(felix86_frame* frame) {
    ...
    if (syscall_number == felix86_x86_64_rt_sigreturn) {
        STRACE("rt_sigreturn: {}");
        Signals::sigreturn(frame->state, true);
        return;
    }
