...
gcc -nostdlib -shared -s -Wl,-soname,linux-vdso.so.1 -Wl,--version-script=vdso-version.map  -o ./x64-linux-vdso.so.1 ./build/vdso64.o
bin2c -o x64-linux-vdso.h x64-linux-vdso.so.1